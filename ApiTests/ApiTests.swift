...
final class ApiTests: XCTestCase {
    ...
    func testSearchRepository() async throws {
        let searchViewModel = SearchViewModel(searchType: SearchEnum.repositories, endpoint: Endpoints.TestEndpoint.swift.rawValue)
    ...
    func testSearchIssue() async throws {
        let searchViewModel = SearchViewModel(searchType: SearchEnum.issues, endpoint: Endpoints.TestEndpoint.swift.rawValue)
        await searchViewModel.fetchDatasForSearchType()
    ...
    func testSearchUser() async throws {
        let searchViewModel = SearchViewModel(searchType: SearchEnum.users, endpoint: Endpoints.TestEndpoint.swift.rawValue)
        await searchViewModel.fetchDatasForSearchType()
